...
int bytes_to_string_utf8_test()
{
	...
	if (str->chars[0] != 0x24) res = 0;
	if (str->chars[1] != 0xA2) res = 0;
	if (str->chars[2] != 0x0939) res = 0;
	if (str->chars[3] != 0x10348) res = 0;
...
int bytes_to_string_utf16_be_bom_test()
{
	...
	if (str->chars[0] != 0x24) res = 0;
	if (str->chars[1] != 0x20AC) res = 0;
	if (str->chars[2] != 0x10437) res = 0;
	if (str->chars[3] != 0x24B62) res = 0;
